...
public class ShooterPivot extends SubsystemBase {
    ...
    public ShooterPivot() {
        ...
        SparkMaxConfig right = new SparkMaxConfig(new SparkMaxStatusFrames(500,
                ...
                20,
                500), 1000, true,
                SparkMaxEncoderType.Absolute, IdleMode.kCoast, 30, 30, true, false, 1, false, new PIDConfig(10, 0, 0,0.04));
        SparkMaxConfig left = new SparkMaxConfig(new SparkMaxStatusFrames(500,
                ...
                20,
                500), 1000, true,
                SparkMaxEncoderType.Absolute, IdleMode.kCoast, 30, 30, false, false, 1, false, new PIDConfig(10, 0, 0,0.04));
