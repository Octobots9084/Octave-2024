...
public class VisionEstimation extends SubsystemBase {
    ...
    private Matrix<N3, N1> confidenceCalculator(EstimatedRobotPose estimation,
            MeanPerPeriodTelemetry confidenceTelemetry) {
    ...
    public Pose2d convert2dCoords(Pose2d pos) {
        ...
        SmartDashboard.putString("poseconvert",
                new Pose2d(pos.getX() - ampXPos, pos.getY() - ampYPos, new Rotation2d())
                        .toString());
        return new Pose2d(pos.getX() - ampXPos, pos.getY() - ampYPos, new Rotation2d());
    }
}