...
public class AlignHotSpots {
    ...
    }, new Translation2d(1.88, FieldConstants.WIDTH),
    ...
    public static final AlignHotSpots BlueClimbTwo = new AlignHotSpots(
            new Triangle[] {
                    new Triangle(new Point(3.17, 4.08), new Point(0, 4.14), new Point(0, FieldConstants.WIDTH)),
                    new Triangle(new Point(0, FieldConstants.WIDTH), new Point(3.17, 4.08), new Point(5.86, 5.78)),
                    new Triangle(new Point(0, FieldConstants.WIDTH), new Point(8.23, FieldConstants.WIDTH),
                            new Point(5.86, 5.78)),
            },
    ...
    public static final AlignHotSpots BlueClimbThree = new AlignHotSpots(
            new Triangle[] { new Triangle(new Point(5.86, 2.46), new Point(8.23, FieldConstants.WIDTH),
                    new Point(5.86, 5.78)),
                    new Triangle(new Point(5.86, 2.46), new Point(8.23, FieldConstants.WIDTH), new Point(8.23, 0)),
                    new Triangle(new Point(10.6, 0), new Point(8.23, FieldConstants.WIDTH), new Point(8.23, 0)),
