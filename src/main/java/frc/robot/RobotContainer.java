...
public class RobotContainer {
    ...
    private final SwerveSubsystem drivebase = new SwerveSubsystem(new File(Filesystem.getDeployDirectory(),
            "swerve"));
    private final VisionEstimation visionEstimation = new VisionEstimation(drivebase);
    ...
    private void configureBindings() {
        ...
        // new JoystickButton(driverXbox, 3).onTrue(new InstantCommand(drivebase::addVisionReading));
